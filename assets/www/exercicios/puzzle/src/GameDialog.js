var neshaug = neshaug || {}; ( function() {
		...
		var STATE_SHOWN = 1, STATE_HIDDEN = 2, STATE_DEFAULT = 0, template = "";
		...
		function GameDialog(canvas) {
			...
			this._text.innerHTML = "Some famous Friends are hidden in this simple word puzzle game." + "They can twist and turn! Click on \"shape\" to make it easier."
		...
		GameDialog.prototype._getElements = function() {
			var el = document.createElement("div"), button = null, text = null;
