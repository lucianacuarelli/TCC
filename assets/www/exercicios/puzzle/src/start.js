( function() {
		var browser = neshaug.Utils.browser, Utils = neshaug.Utils, size = 0, canvas = null, container = null, letterPainter = null, bgImage = null;
		...
		function onReady(letters) {
			var game = null, menu = null, gameDialog;
