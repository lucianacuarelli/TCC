var neshaug = neshaug || {}; ( function() {
		...
		var DIR_LEFT = 0, DIR_RIGHT = 1, DIR_UP = 2, DIR_DOWN = 3;

		function getMaxAndMin(points) {
			var maxX = null, minX = null, maxY = null, minY = null, i = null, length = null;
		...
		function Shape(word) {
			...
			this.toOrigin = function() {
				var maxAndMin = getMaxAndMin(this.points), minX = maxAndMin.minX, minY = maxAndMin.minY;
		...
		Shape.shapeify = function(word, random) {
			var shape = null, i = 0, x = 0, y = 0, lastX = 0, lastY = 0, validMoves = null, direction = null;
